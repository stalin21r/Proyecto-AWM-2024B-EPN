  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="menu">
          <NavLink className={({ isActive }) => (isActive ? 'menu-item active' : 'menu-item')} to="/administracion/inicio">
            Inicio
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'menu-item active' : 'menu-item')} to="/administracion/tienda">
            Tienda
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'menu-item active' : 'menu-item')} to="/administracion/casilleros">
            Casilleros
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'menu-item active' : 'menu-item')} to="/administracion/turnos-y-asistencia">
            Turnos y Asistencia
          </NavLink>
          {user.rol === true && (
            <NavLink className={({ isActive }) => (isActive ? 'menu-item active' : 'menu-item')} to="/administracion/usuarios">
        ...
        <div className="user-menu-container">
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <IconButton aria-controls="user-menu" aria-haspopup="true" onClick={handleUserMenuClick} color="inherit" size="large">
